...
REGISTER_GRAD(mul, [](const std::vector<Variable*>& inputs, const std::vector<Variable*>& ginputs) -> std::vector<Variable*> {
  return {
...
REGISTER_SHAPE(mul, [](const std::vector<Variable*>& inputs) -> std::vector<Size> {
